...
use super::types::{
    AllSessionsEntry, AllSessionsResponse, ChatAgent, ChatMessage, ClaudeContext, MessageRole,
...
pub async fn send_chat_message(
    ...
    log::trace!("Sending chat message for session: {session_id}, worktree: {worktree_id}, agent: {agent:?}, model: {model:?}, execution_mode: {execution_mode:?}, thinking: {thinking_level:?}, disable_thinking_for_mode: {disable_thinking_for_mode:?}, allowed_tools: {allowed_tools:?}");
